...
L_1=function(xx)
{
  ...
  {
    sum_4=sum_4+(k*(R[i]+1)-1)*((updated_pi1)*(1-(1-(1+Data[i])^(-updated_lambda_1))^updated_alpha_1))/((updated_pi1*(1-(1-(1+Data[i])^(-updated_lambda_1))^updated_alpha_1)) +((updated_pi2)*(1-(1-(1+Data[i])^(-updated_lambda_2))^updated_alpha_2))+ ((1-updated_pi1-updated_pi2)*(1-(1-(1+Data[i])^(-updated_lambda_3))^updated_alpha_3)))
    
    sum_5=sum_5+log(1-(1-(1+Data[i])^(-y))^x)*(k*(R[i]+1)-1)*((updated_pi1)*(1-(1-(1+Data[i])^(-updated_lambda_1))^updated_alpha_1))/((updated_pi1*(1-(1-(1+Data[i])^(-updated_lambda_1))^updated_alpha_1)) +((updated_pi2)*(1-(1-(1+Data[i])^(-updated_lambda_2))^updated_alpha_2))+ ((1-updated_pi1-updated_pi2)*(1-(1-(1+Data[i])^(-updated_lambda_3))^updated_alpha_3)))
  }
  for(i in 1:length(Data1))
  {
    sum_6=sum_6+log(x)+log(y)-(y+1)*log(1+Data1[i])+(x-1)*log(1-(1+Data1[i])^(-y))
  }
...
L_2=function(yy)
{
  ...
  for(i in 1:length(Data))
  {
    sum_4=sum_4+(k*(R[i]+1)-1)*((updated_pi2)*(1-(1-(1+Data[i])^(-updated_lambda_2))^updated_alpha_2))/((updated_pi1*(1-(1-(1+Data[i])^(-updated_lambda_1))^updated_alpha_1)) +((updated_pi2)*(1-(1-(1+Data[i])^(-updated_lambda_2))^updated_alpha_2))+ ((1-updated_pi1-updated_pi2)*(1-(1-(1+Data[i])^(-updated_lambda_3))^updated_alpha_3)))
    
    sum_5=sum_5+log(1-(1-(1+Data[i])^(-y))^x)*(k*(R[i]+1)-1)*((updated_pi2)*(1-(1-exp(-updated_lambda_2*Data[i]))^updated_alpha_2))/((updated_pi1*(1-(1-(1+Data[i])^(-updated_lambda_1))^updated_alpha_1)) +((updated_pi2)*(1-(1-(1+Data[i])^(-updated_lambda_2))^updated_alpha_2))+ ((1-updated_pi1-updated_pi2)*(1-(1-(1+Data[i])^(-updated_lambda_3))^updated_alpha_3)))
  }
  for(i in 1:length(Data2))
  {
    sum_6=sum_6+log(x)+log(y)-(y+1)*log(1+Data2[i])+(x-1)*log(1-(1+Data2[i])^(-y))
  }
...
L_3=function(zz)
{
  ...
  for(i in 1:length(Data))
  {
    sum_4=sum_4+(k*(R[i]+1)-1)*((1-updated_pi1-updated_pi2)*(1-(1-(1+Data[i])^(-updated_lambda_3))^updated_alpha_3))/((updated_pi1*(1-(1-(1+Data[i])^(-updated_lambda_1))^updated_alpha_1)) +((updated_pi2)*(1-(1-(1+Data[i])^(-updated_lambda_2))^updated_alpha_2))+ ((1-updated_pi1-updated_pi2)*(1-(1-(1+Data[i])^(-updated_lambda_3))^updated_alpha_3)))
    
    sum_5=sum_5+log(1-(1-(1+Data[i])^(-y))^x)*(k*(R[i]+1)-1)*((1-updated_pi1-updated_pi2)*(1-(1-(1+Data[i])^(-updated_lambda_3))^updated_alpha_3))/((updated_pi1*(1-(1-(1+Data[i])^(-updated_lambda_1))^updated_alpha_1)) +((updated_pi2)*(1-(1-(1+Data[i])^(-updated_lambda_2))^updated_alpha_2))+ ((1-updated_pi1-updated_pi2)*(1-(1-(1+Data[i])^(-updated_lambda_3))^updated_alpha_3)))
  }
  for(i in 1:length(Data3))
  {
    sum_6=sum_6+log(x)+log(y)-(y+1)*log(1+Data3[i])+(x-1)*log(1-(1+Data3[i])^(-y))
  }
...
while(indicatorr<1)
{
  ...
  updated_1<-optim(c(alpha_1,lambda_1),L_1,lower=0.01, upper=6, method="L-BFGS-B", control=list(fnscale=-1))$par
  updated_alpha_1<-updated_1[1]
  updated_lambda_1<-updated_1[2]
  updated_2<-optim(c(alpha_2,lambda_2),L_2,lower=0.01, upper=6, method="L-BFGS-B", control=list(fnscale=-1))$par
  updated_alpha_2<-updated_2[1]
  updated_lambda_2<-updated_2[2]
  updated_3<-optim(c(alpha_3,lambda_3),L_3,lower=0.01, upper=6, method="L-BFGS-B", control=list(fnscale=-1))$par
...
MLL<-function(p1,p2,a,b,c,d,e,f)
{
  ...
  for(i in 1:length(Data3))
  {
    sum3=sum3+log(f)-(f+1)*log(1+Data3[i])+(e-1)*log(1-(1+Data3[i])^(-f))
  }
  for(i in 1: length(Data))
  {
    sum4=sum4+(k*(R[i]+1)-1)*log(p1*(1-(1-(1+Data[i])^(-b))^a)+(p2)*(1-(1-(1+Data[i])^(-d))^c)+ (1-p1-p2)*(1-(1-(1+Data[i])^(-f))^e))
  }
