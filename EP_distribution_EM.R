...
L_1=function(xx)
{
  ...
  {
    sum_1=sum_1+(k*(R[i]+1)-1)*(updated_pi*(1-(1-(1+Data[i])^(-updated_lambda_1))^updated_alpha_1))/((updated_pi*(1-(1-(1+Data[i])^(-updated_lambda_1))^updated_alpha_1)) +((1-updated_pi)*(1-(1-(1+Data[i])^(-updated_lambda_2))^updated_alpha_2)))
    
    sum_2=sum_2+log(1-(1-(1+Data[i])^(-y))^x)*(k*(R[i]+1)-1)*(updated_pi*(1-(1-(1+Data[i])^(-updated_lambda_1))^updated_alpha_1))/((updated_pi*(1-(1-(1+Data[i])^(-updated_lambda_1))^updated_alpha_1)) +((1-updated_pi)*(1-(1-(1+Data[i])^(-updated_lambda_2))^updated_alpha_2)))
  }
  for(i in 1:length(Data1))
  {
    sum_3=sum_3+log(x)+log(y)-(y+1)*log(1+Data1[i])+(x-1)*log(1-(1+Data1[i])^(-y))
  }
...
L_2=function(yy)
{
  ...
  for(i in 1:length(Data))
  {
    sum_4=sum_4+(k*(R[i]+1)-1)*((1-updated_pi)*(1-(1-(1+Data[i])^(-updated_lambda_2))^updated_alpha_2))/((updated_pi*(1-(1-(1+Data[i])^(-updated_lambda_1))^updated_alpha_1)) +((1-updated_pi)*(1-(1-(1+Data[i])^(-updated_lambda_2))^updated_alpha_2)))
    
    sum_5=sum_5+log(1-(1-(1+Data[i])^(-y))^x)*(k*(R[i]+1)-1)*((1-updated_pi)*(1-(1-(1+Data[i])^(-updated_lambda_2))^updated_alpha_2))/((updated_pi*(1-(1-(1+Data[i])^(-updated_lambda_1))^updated_alpha_1)) +((1-updated_pi)*(1-(1-(1+Data[i])^(-updated_lambda_2))^updated_alpha_2)))
  }
...
for(ll in 1:1000)
{
  ...
  while(indicatorr<1)
  {
    ...
    for(i in 1:length(Data))
    {
      sum_6=sum_6+(k*(R[i]+1)-1)*(updated_pi*(1-   (1-(1+Data[i])^(-updated_lambda_1))^updated_alpha_1  ))/((updated_pi*(1-(1-(1+Data[i])^(-updated_lambda_1))^updated_alpha_1)) +((1-updated_pi)*(1-(1-(1+Data[i])^(-updated_lambda_2))^updated_alpha_2)))
    ...
    if((updated_alpha_1>0)&&(updated_lambda_1>0)&&(updated_lambda_2>0)&&(updated_alpha_2>0)&&(updated_pi>0))
    {
    ...
    if((abs(pi_mle[2]-pi_mle[1])<0.01)&&(abs(alpha_1_mle[2]-alpha_1_mle[1])<0.01)&&(abs(lambda_1_mle[2]-lambda_1_mle[1])<0.01)&&(abs(lambda_2_mle[2]-lambda_2_mle[1])<0.01)&&(abs(alpha_2_mle[2]-alpha_2_mle[1])<0.01))
    {
      indicatorr<-1
    }
  }
